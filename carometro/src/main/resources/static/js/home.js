  ...
  inputPesquisa.addEventListener("keypress", function (e) {
    if (e.key === "Enter") {
      ...
      if (termoPesquisa.includes("@")) {
        ...
        alert("Digite um identificador válido (deve conter @)");
      }
    }
  });
});
...
function editarPerfil() {
  ...
  document.getElementById("voltar").addEventListener("click", perfil);
  document.getElementById("btnPerfil").addEventListener("click", perfil);
}

// Funções para adicionar experiências
...
// Iniciar com a visualização do perfil
perfil();
